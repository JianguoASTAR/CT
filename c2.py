...
basepath = r"G:\SMART\PySMART\data3\HCC"
...
#3 保存CT扫描文件路径
writeData2CSV(childPathList, "../data3/H1_CTPathList_batch2.csv")

#4 获取患者信息并统计CT图像数量
patientScanList = getPatientScanIDs(basepath, childPathList)

#5 保存CT图像信息
writeData2CSV(patientScanList, "../data3/H1_patientScanImageCount10.csv")

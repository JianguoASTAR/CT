...
#3 生成NRRD文件
def saveNRRDBySimpleITK(patientList,pathList):
    for i in range(len(pathList)):
        dicompath= pathList[i]
        ...
        series_file_names = sitk.ImageSeriesReader.GetGDCMSeriesFileNames(dicompath, series_ids[0])
        ...
        sitk.WriteImage(img2, '../data3/A001_Se6.nrrd')
